 ...
 * JUnit tests.
 */
public class TestDateTimeFormatter extends GWTTestCase {

    private static final boolean SUCCESS = true;

//  public TestDateTimeFormatter() {
//      setName("TestDateTimeFormatter");
//  }
...
//    junit.textui.TestRunner.main(testCaseName);
    ...
    public void testSpeedJDK() throws ParseException {
        ...
        Date result = DateTimeFormat.getFormat("yyyy-MM-dd hh:mm:ss").parse(dateTime);
        String dateResurrected = DateTimeFormat.getFormat("yyyy-MM-dd hh:mm:ss").format(result);
    }
    ...
    public void testDate() {
        ...
        testDate(SUCCESS, "2099-11-28", "WWW MMM DD, YYYY", LocaleInfo.getCurrentLocale(), "Sat Nov 28, 2099");
        testDate(SUCCESS, "2099-11-28", "WWW-DD|th|", LocaleInfo.getCurrentLocale(), "Sat-28th");
        ...
        testDate(SUCCESS, "2009-12-31", "WWWW, MMM D, YYYY", LocaleInfo.getCurrentLocale(), "Thursday, Dec 31, 2009");
        testDate(SUCCESS, "2009-12-31", "WWW, MMM D, YYYY", LocaleInfo.getCurrentLocale(), "Thu, Dec 31, 2009");
        ...
        testDate(SUCCESS, "2009-10-28 01:59:01", "YYYY-MM-DD h12:mm:ss a", LocaleInfo.getCurrentLocale(), "2009-10-28 1:59:01 AM");
        testDate(SUCCESS, "2009-10-28 13:59:01", "YYYY-MM-DD h12:mm:ss a", LocaleInfo.getCurrentLocale(), "2009-10-28 1:59:01 PM");
        ...
        testDate(SUCCESS, "2009-10-28 13:59:01", "YYYY-MM-DD h12:mm:ss||a", LocaleInfo.getCurrentLocale(), "2009-10-28 1:59:01PM");
    }

    public void testEscapeChar() {
        testDate(SUCCESS, "2009-10-28 01:59:01", "|Date:|YYYY-MM-DD |Time:|hh12:mm:ss", "Date:2009-10-28 Time:01:59:01");
        System.out.println("Первый отработал");
        testDate(SUCCESS, "15:59:59", "h12| o'clock| a", LocaleInfo.getCurrentLocale(), "3 o'clock PM");
        System.out.println("второй отработал");
        ...
        System.out.println("третий отработал");
    }
    ...
    private void testDate(boolean aSuccess, String aDate, String aFormat, LocaleInfo aLocale, String aExpectedResult) {
        DateTimeParser parser = new DateTimeParser();
        DateTime dateTime = parser.parse(aDate);
